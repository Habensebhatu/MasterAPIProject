...
namespace Data_layer.Migrations.MyDb
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstokeOfPiece = table.Column<int>(type: "int", nullable: true),
                    CratePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CrateQuantity = table.Column<int>(type: "int", nullable: true),
                    InstokeOfCrate = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserRegistrationEntityModelUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Order_UserRegistration_UserRegistrationEntityModelUserId",
                        column: x => x.UserRegistrationEntityModelUserId,
                        principalTable: "UserRegistration",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderAit", x => x.OrderId);
                    table.ForeignKey(
                        name: "FK_OrderAit_UserRegistration_UserId",
                        column: x => x.UserId,
                        principalTable: "UserRegistration",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    OrderAitOrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetailAit", x => x.OrderDetailId);
                    table.ForeignKey(
                        name: "FK_OrderDetailAit_OrderAit_OrderAitOrderId",
                        column: x => x.OrderAitOrderId,
                        principalTable: "OrderAit",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderDetailAit_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_UserRegistrationEntityModelUserId",
                table: "Order",
                column: "UserRegistrationEntityModelUserId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderAit_UserId",
                table: "OrderAit",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetailAit_OrderAitOrderId",
                table: "OrderDetailAit",
                column: "OrderAitOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderDetailAit_ProductId",
                table: "OrderDetailAit",
                column: "ProductId");
