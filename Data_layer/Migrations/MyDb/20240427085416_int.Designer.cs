...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data_layer.Context.OrderDetailEntityAit", b =>
                {
                    b.Property<Guid>("OrderDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("OrderAitOrderId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OrderAitOrderId");

                    b.HasIndex("ProductId");

                    b.ToTable("OrderDetailAit");
                });

            modelBuilder.Entity("Data_layer.Context.OrderEntiyAit", b =>
                {
                    b.Property<Guid>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Data_layer.Context.OrderDetailEntityAit", b =>
                {
                    b.HasOne("Data_layer.Context.OrderEntiyAit", "OrderAit")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderAitOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
